...
import { GroupApplicationPage } from './_components/group-application-page'

import { getIsCustomDomain } from '@/lib/get-is-custom-domain'
import { buildOrgHref } from '@/lib/org-href'

interface GroupCandidaturaPageProps {
  params: Promise<{ slug: string; groupId: string }>
}

export default async function GroupCandidaturaPage({
  params,
}: GroupCandidaturaPageProps) {
  ...
  return (
    <div className="min-h-screen px-4 py-6 sm:px-6 lg:px-8 lg:py-10">
      <div className="mx-auto w-full max-w-5xl space-y-6">
        ...
        <GroupApplicationPage slug={slug} groupId={groupId} />
      </div>
    </div>
  )
}
